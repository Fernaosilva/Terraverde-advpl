...
Method dadosVencidos(cDiasVenc) Class TVCLCOB
	...
	cQuery += " SE1.E1_CLIENTE,E1_LOJA,E1_VEND1,E1_CLIENTE,E1_LOJA,E1_NUM,E1_PARCELA,E1_EMISSAO,E1_VENCREA,E1_VALOR,E1_SALDO, "   + CRLF                                        + CRLF
...
Method montaHtmlEmail(cTipo, aDados) Class TVCLCOB
	...
	local lUsaTLS     := .F.
	local lUsaSSL     := .T.
	local cEmailComp  := SuperGetMV("ZZ_EMAILCOB",.F.,"contasareceber@terraverdeagro.com.br")
