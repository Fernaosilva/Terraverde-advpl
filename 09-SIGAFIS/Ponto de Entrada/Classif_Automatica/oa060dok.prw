...
//	ClasDoc(nRecSF1) --desmarcado para nao chamar no coletor
	RestArea(aArea)
...
Static Function ClasDoc(nRecSF1)
	...
	//VLDAMNFE indicando se deve ou não fazer a validação da chave juntamente 
	...
	//MUDA O USUARIO DA CLASSIFICAÇÃO
